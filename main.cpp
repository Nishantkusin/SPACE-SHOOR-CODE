...
void introScreen()
{
	...
	displayRasterText(-100, 150, 0.0,"created by");
		glColor3f(1.0, 1.0, 1.0);
	 displayRasterText(-130, 80, 0.0,"TEAM SHOOTERS");
	 	glColor3f(1.0, 0.0, 0.0);
	  displayRasterText(-800, -100, 0.0," STUDENT NAMES");
	  	glColor3f(1.0, 1.0, 1.0);
	displayRasterText(-800, -200, 0.0," KUMAR ARYAN");
	displayRasterText(-800, -285, 0.0," NISHANT KUMAR SINHA");
		glColor3f(1.0, 0.0, 0.0);
	displayRasterText(500, -100, 0.0,"Under the Guidance of");
		glColor3f(1.0, 1.0, 1.0);
	displayRasterText(500, -200, 0.0,"Prof SHANKAR R");
	displayRasterText(500, -285, 0.0,"Prof. CHETHANA C");
		glColor3f(1.0, 0.0, 0.0);
